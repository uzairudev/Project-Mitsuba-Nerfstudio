...
class SplatfactoModel(Model):
    ...
    def get_image_metrics_and_images(
        ...
        # Replicate the B channel in R and G channels for both ground truth and predicted images
        gt_rgb_b = gt_rgb[:, :, 2:3]  # Extract B channel
        gt_rgb = torch.cat([gt_rgb_b, gt_rgb_b, gt_rgb_b], dim=2)  # Replicate B channel into R and G

        predicted_rgb_b = predicted_rgb[:, :, 2:3]  # Extract B channel
        predicted_rgb = torch.cat([predicted_rgb_b, predicted_rgb_b, predicted_rgb_b], dim=2)  # Replicate B channel into R and G
