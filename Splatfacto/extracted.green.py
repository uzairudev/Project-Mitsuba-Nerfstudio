...
class SplatfactoModel(Model):
    ...
    def get_image_metrics_and_images(
        ...
        # Replicate the G channel in R and B channels for both ground truth and predicted images
        gt_rgb_g = gt_rgb[:, :, 1:2]  # Extract G channel
        gt_rgb = torch.cat([gt_rgb_g, gt_rgb_g, gt_rgb_g], dim=2)  # Replicate G channel into R and B

        predicted_rgb_g = predicted_rgb[:, :, 1:2]  # Extract G channel
        predicted_rgb = torch.cat([predicted_rgb_g, predicted_rgb_g, predicted_rgb_g], dim=2)  # Replicate G channel into R and B
